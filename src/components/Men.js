  ...
  return (
    <div className="container">
      ...
      <div className="main-content">
        ...
        <h1>Elegance Meets Modern Masculinity</h1>
        <h3 className="page-intro">
          ...
          Our collection embodies strength confidence and sophistication — crafted for the man who values timeless style and effortless charm.
        </h3>
      </div>
      ...
      {/* PROMO SECTION */}
      <div className="promotional-banner Men-banner">
